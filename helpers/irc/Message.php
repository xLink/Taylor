...
final class Message
{
    ...
    public static function make($command, $parameter = '', $sender = null)
    {
        ...
        if (count($args) && end($args) instanceof Sender) {
    ...
    {
        return $this->command === 'ERROR' or (is_numeric($this->command) && '400' <= $this->command && $this->command <= '599');
    }
     ...
     * @param  string  $method The command to send.
    ...
    public static function quit($message = '')
    {
        ...
        return static::make('QUIT', ":$message");
    }
